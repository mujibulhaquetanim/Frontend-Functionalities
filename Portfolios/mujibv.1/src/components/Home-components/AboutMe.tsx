...
export default function AboutMe() {
  return (
    <div className="min-h-screen backdrop-blur-xl grid grid-flow-col place-items-center place-content-center">
      <div className="grid place-items-center place-content-center grid-cols-12 grid-rows-8 gap-2">
        <div className="col-span-6 row-span-8 border-2 border-slate-700/80 bg-slate-700/80 text-white backdrop-blur-xl rounded-xl p-5 space-y-5 text-justify">
        ...
        <div className="col-span-6 row-span-4 border-2 border-slate-700/80 bg-slate-700/80 text-white backdrop-blur-xl rounded-xl p-5 space-y-5">
        ...
        <div className="text-xl col-span-6 row-span-4 border-2 border-slate-700/80 bg-slate-700/80 text-white backdrop-blur-xl rounded-xl p-5">
          timeline
        </div>
      </div>
    </div>
