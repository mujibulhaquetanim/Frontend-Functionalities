...
const cardClassName = [
  "group/timeline relative w-full h-full overflow-hidden rounded-2xl border border-white/10 bg-slate-900/55 bg-[radial-gradient(circle_at_12%_0%,rgba(255,255,255,0.10),transparent_32%),radial-gradient(circle_at_92%_100%,rgba(56,189,248,0.10),transparent_38%)] p-5 text-slate-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_10px_28px_rgba(15,23,42,0.20)] backdrop-blur-md transition-[border-color,background-color,box-shadow] duration-500 hover:border-sky-300/20 hover:bg-slate-900/65 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.09),0_14px_34px_rgba(15,23,42,0.28),0_0_24px_rgba(56,189,248,0.06)]",
  className,
]
  .filter(Boolean)
  .join(" ");
  ...
  <div className={cardClassName} style={styles.card}>
    <div style={styles.header}>
      <div>
        ...
        <div className="animate-git-shimmer" style={styles.skeletonSubtitle} />
      </div>
    </div>
...
return (
  ...
  <div style={styles.note}>
    Contribution data matches the calendar shown on the public GitHub profile.
  </div>
</div>
);
}
